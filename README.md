# Introduction
EShiksha is scalable web application written in python (django).
EShiksha was designed to provide pleasant experience for users.
...
EShiksha application in this directory:
